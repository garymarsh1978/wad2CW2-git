...
exports.registerUser = [
    check("username", "Donator must be at least 3 characters")
        .not()
        .isEmpty()
        .isLength({ min: 8 }),
    ...
    check("password").exists().isLength({min: 8}).trim().escape().withMessage('Password  must have more than 8 characters'),
    ];
